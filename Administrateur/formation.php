...
if(isset($_POST['submit'])){
  ...
  $v1="<script> dialoginfo(\"Champs Libellé est vide\",\"formation.php\"); </script>";
       }
  ...
  if (isset($_POST['editF'])) {
    ...
    $tabF=selectDB("SELECT * FROM cotisation WHERE libelle_cotisation='$editF'"); 
...
<div class="jumbotron jumbotron-fluid cotisation accueil">
  ...
  <div class="form-row">
    <div class="col-md-4 mb-3">
      ...
      <input type="text" class="form-control" id="libelleForma" placeholder="Libellé de la Formation" name="libelleForma" value="<?php  ?>" >
    </div>
  </div>
    ...
    <div class="col-sm-4">
      <div class="form-check">
        <input class="form-check-input" type="checkbox" id="gridCheck1" name="age">
