...
<table class="table table-striped">
  ...
  <tbody id="ul">
    ...
    <?php
     foreach ($tab as $key) {
      ...
      <a href=\"edite.php?edit=".utf8_encode($key['id_formation'])."\"><i class=\"fas fa-user-edit\"></i></a>&nbsp;";
  ...
  <div class=\"modal-dialog\" role=\"document\">
    <div class=\"modal-content\">
     ...
     $var.="<input type=\"text\" class=\"form-control\"  placeholder=".$respreqi['libellePreroquis']." readonly> </br>";
         }
