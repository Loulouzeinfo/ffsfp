...
<p>Votre compte a été validé par la FFSFP. Vous pouvez désormais vous connecter avec l\'identifiant suivant :<p>
<p>Identifiant: '.$sess.'</p>
<p>cordialement, La FFSFP</p>');         //An HTML or plain text message body
